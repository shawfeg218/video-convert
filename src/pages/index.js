...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between ">
      <div className="flex flex-wrap min-h-screen w-full justify-around px-4 py-10 ">
        <section className="min-h-full overflow-y-hidden w-full max-w-xl bg-white px-2 pt-3 pb-1 rounded-md">
          ...
          <ul className="max-h-96 overflow-y-auto mt-2 h-3/4">
            ...
            {files.map((file) => (
              ...
              >
                <li className="w-1/3 truncate overflow-hidden" title={file}>
                  {file}
                </li>
          ...
          <div className="mt-2 border-t-2 h-40 overflow-y-scroll ">
            {waiting.length === 0 ? (
              <p>沒有影片等待轉檔</p>
            ) : (
        ...
        <section className="min-h-full w-full max-w-xl bg-white px-2 py-3 pb-1 rounded-md max-xl:mt-3 relative">
          {message && (
